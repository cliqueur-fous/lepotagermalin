...
// ═══════ QUANTITÉS RECOMMANDÉES POUR 2 PERSONNES ═══════
// Sources : Rustica, Vilmorin, Terre Vivante — rendements moyens zone tempérée France
// Basé sur une consommation standard de 2 adultes sur la saison
const RECOMMENDED_QTY = {
  tomate:      { qty: 8,  unit: "pieds",     note: "~40 kg/saison, base de la cuisine d'été" },
  carotte:     { qty: 200,unit: "graines (3m)",note: "~14 kg, semis échelonnés sur 3m linéaires" },
  courgette:   { qty: 3,  unit: "pieds",     note: "Très productive, 3 pieds = ~15 kg" },
  salade:      { qty: 20, unit: "plants",    note: "Semer 5 plants toutes les 3 semaines" },
  haricot:     { qty: 80, unit: "graines (5m)",note: "~8 kg, semer en 2 fois (juin + juillet)" },
  radis:       { qty: 100,unit: "graines (2m)",note: "Semer un petit rang toutes les 2 semaines" },
  poivron:     { qty: 4,  unit: "pieds",     note: "~8 kg, récolter vert ou coloré" },
  piment:      { qty: 2,  unit: "pieds",     note: "2 pieds suffisent largement" },
  aubergine:   { qty: 4,  unit: "pieds",     note: "~12 kg, gourmande en chaleur" },
  concombre:   { qty: 2,  unit: "pieds",     note: "~8 kg, très productif" },
  cornichon:   { qty: 3,  unit: "pieds",     note: "Récolter tous les 2 jours !" },
  pdt:         { qty: 20, unit: "plants",    note: "~30 kg, 8m linéaires env." },
  patatedouce: { qty: 6,  unit: "plants",    note: "~9 kg, besoin de chaleur" },
  petitpois:   { qty: 100,unit: "graines (4m)",note: "~4 kg écossés, semer tôt" },
  feve:        { qty: 60, unit: "graines (3m)",note: "~6 kg de gousses" },
  oignon:      { qty: 40, unit: "bulbilles",  note: "~6 kg, se conserve bien" },
  echalote:    { qty: 20, unit: "bulbes",     note: "~3 kg, chaque bulbe donne 4-6 échalotes" },
  ail:         { qty: 20, unit: "caïeux",     note: "~2 kg, planter en automne ou février" },
  poireau:     { qty: 30, unit: "plants",     note: "~7 kg, récolte automne-hiver" },
  epinard:     { qty: 60, unit: "graines (2m)",note: "~3 kg, printemps + automne" },
  mache:       { qty: 80, unit: "graines (2m)",note: "~1 kg, salade d'hiver par excellence" },
  roquette:    { qty: 40, unit: "graines (1m)",note: "Pousse vite, semer peu mais souvent" },
  blette:      { qty: 4,  unit: "pieds",     note: "~4 kg, productive et facile" },
  betterave:   { qty: 30, unit: "graines (2m)",note: "~6 kg, bonne conservation" },
  chou:        { qty: 6,  unit: "plants",    note: "~12 kg, prévoir anti-piérides" },
  navet:       { qty: 40, unit: "graines (2m)",note: "~6 kg, top en automne" },
  panais:      { qty: 20, unit: "graines (1m)",note: "~4 kg, goût amélioré par le gel" },
  celeri:      { qty: 4,  unit: "plants",    note: "~3 kg, long mais gratifiant" },
  fenouil:     { qty: 6,  unit: "graines",   note: "~2 kg de bulbes" },
  mais:        { qty: 16, unit: "graines",   note: "Semer en carré 4×4 minimum (pollinisation)" },
  topinambour: { qty: 6,  unit: "tubercules", note: "~9 kg, attention envahissant !" },
  potimarron:  { qty: 2,  unit: "pieds",     note: "~16 kg, 3-4 fruits/pied" },
  butternut:   { qty: 2,  unit: "pieds",     note: "~12 kg, se conserve tout l'hiver" },
  fraise:      { qty: 15, unit: "pieds",     note: "~5 kg, remontantes pour toute la saison" },
  framboise:   { qty: 6,  unit: "pieds",     note: "~9 kg, vivace et productive" },
  melon:       { qty: 3,  unit: "pieds",     note: "~9 kg, limiter à 4 fruits/pied" },
  pasteque:    { qty: 2,  unit: "pieds",     note: "~10 kg, besoin de place et chaleur" },
  rhubarbe:    { qty: 2,  unit: "pieds",     note: "~6 kg, vivace, planter une fois" },
  groseille:   { qty: 2,  unit: "pieds",     note: "~6 kg, arbuste facile" },
  basilic:     { qty: 4,  unit: "pieds",     note: "Indispensable avec les tomates" },
  persil:      { qty: 3,  unit: "pieds",     note: "Bisannuel, semer chaque année" },
  ciboulette:  { qty: 2,  unit: "touffes",   note: "Vivace, diviser tous les 3 ans" },
  menthe:      { qty: 2,  unit: "pieds",     note: "En pot enterré sinon elle envahit tout" },
  thym:        { qty: 2,  unit: "pieds",     note: "Vivace, récolte toute l'année" },
  romarin:     { qty: 1,  unit: "pied",      note: "Un seul suffit, il devient un arbuste" },
  coriandre:   { qty: 3,  unit: "semis",     note: "Semer tous les 3 semaines (monte vite)" },
  aneth:       { qty: 2,  unit: "semis",     note: "Se ressème tout seul" },
  cerfeuil:    { qty: 3,  unit: "semis",     note: "Mi-ombre, semer régulièrement" },
  estragon:    { qty: 1,  unit: "pied",      note: "Un pied suffit, vivace" },
  sauge:       { qty: 1,  unit: "pied",      note: "Vivace, un pied couvre les besoins" },
  origan:      { qty: 1,  unit: "pied",      note: "Vivace, sèche très bien" },
  lavande:     { qty: 2,  unit: "pieds",     note: "Pour les pollinisateurs et la cuisine" },
};
